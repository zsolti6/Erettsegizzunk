    ...
    const fetchStreak = async () => {
      try {
        const response = await axios.post(
          `${BASE_URL}/erettsegizzunk/UserStatistics/get-streak-count`,
          {
            userId: user.id,
            token: user.token,
          }
      ...
      >
        <div className="container">
          ...
          <p className="lead text-white">
            Folytasd a gyakorlást, kövesd a fejlődésed, és készülj fel az
            érettségire!
          </p>
          <a
            href="/feladat-valasztas"
            ...
            {streak < 0 ? (
              ...
              <p className="streak-text text-white fs-2">
                ...
                >
                  ...
                  <g id="SVGRepo_iconCarrier">
                    <path
                      d="M64,12a37.89,37.89,0,0,0-25.3,9.65L39,22l4,12L26,59.5V99h76V50A38,38,0,0,0,64,12ZM50,49H60V39h8V49H78v8H68V76H60V57H50Z"
                      fill="#707782"
                    ></path>
                    <path
                      d="M64,12c-1.18,0-2.36,0-3.51.16A38,38,0,0,1,95,50V99h7V50A38,38,0,0,0,64,12Z"
                      fill="#fff"
                    ></path>
                    <polygon
                      points="68 57 68 76 60 76 60 57 50 57 50 49 60 49 60 39 68 39 68 49 78 49 78 57 68 57"
                      fill="#b7bec8"
                    ></polygon>
                    <rect
                      height="18"
                    ...
                    ></rect>
                    <path
                      d="M14,99v18H52v-3a2,2,0,0,1,2-2H97a3,3,0,0,0,3-3V99Z"
                      fill="#707782"
                    ></path>
                    <path
                      d="M95,93v6H26V59.5l6-9V88a5,5,0,0,0,5,5Z"
                      fill="#58616d"
                    ></path>
                    <rect
                      height="18"
                    ...
                    ></rect>
                    <path
                      d="M78,60H65V54H75V52H65V46H78a3,3,0,0,1,3,3v8A3,3,0,0,1,78,60Z"
                      fill="#31352e"
                    ></path>
                    <path
                      d="M68,79H60a3,3,0,0,1-3-3V54h6V73h2V54h6V76A3,3,0,0,1,68,79Z"
                      fill="#31352e"
                    ></path>
                    <path
                      d="M63,60H50a3,3,0,0,1-3-3V49a3,3,0,0,1,3-3H63v6H53v2H63Z"
                      fill="#31352e"
                    ></path>
                    <path
                      d="M71,52H65V42H63V52H57V39a3,3,0,0,1,3-3h8a3,3,0,0,1,3,3Z"
                      fill="#31352e"
                    ></path>
                    <path
                      d="M114,96H29V60.41L44.61,37H50c4,0,4-6,0-6H45.16l-2.83-8.48A35,35,0,0,1,99,50V90a3,3,0,0,0,6,0V50c0-35.41-42.06-54-68.31-30.58a3,3,0,0,0-.36,4.07l3.36,10.07L23.5,57.84A3,3,0,0,0,23,59.5V96H14a3,3,0,0,0-3,3v18a3,3,0,0,0,3,3H114a3,3,0,0,0,3-3V99A3,3,0,0,0,114,96Zm-3,18H17V102h94Z"
                      fill="#31352e"
                    ></path>
                  </g>
                </svg>
          ...
          <div className="row">
            <div className="col-md-4 text-center">
              <div className="feature-item p-4 shadow-sm">
                ...
                <p>
                  Válassz új feladatokat és kezdj el gyakorolni különböző
                  tantárgyakból.
                </p>
                <a
                  href="/feladat-valasztas"
            ...
            <div className="col-md-4 text-center">
              <div className="feature-item p-4 shadow-sm">
                ...
                <p>
                  Kövesd a fejlődésed és nézd meg, mely területeken érdemes még
                  gyakorolnod.
                </p>
      ...
      >
        <div className="container">
          ...
          <p className="lead mb-4 text-white">
            Nézd meg a statisztikáidat, vagy válassz új feladatokat a további
            gyakorláshoz.
          </p>
          <a
            href="/statisztika"
            className="btn btn-light btn-lg color-bg3 border-0 me-3"
          >
            Statisztikák
          </a>
          <a
            href="/feladat-valasztas"
            className="btn btn-light btn-lg color-bg2 border-0"
          >
            Új teszt megkezdése
          </a>
        </div>
